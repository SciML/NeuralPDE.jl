...
sol = solve(prob, NeuralNetDiffEq.nnode(chain,opt), dt=1/20f0, abstol=1e-10, maxiters=1000)
...
prob = ODEProblem(ODEFunction(linear,analytic=linear_analytic),1/2f0,(0.0f0,1.0f0))
dts = 1f0 ./ 2f0 .^ (10:-1:7)
