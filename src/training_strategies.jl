...
@non_differentiable function generate_random_points(points, bound, eltypeθ)
    lb, ub = bound
...
@non_differentiable function generate_quasi_random_points_batch(points, bound, eltypeθ, sampling_alg,
                                                    minibatch)
    lb, ub = bound
